...
SERVICES_CYCLE = ["std", "ckd", "glp1", "foreign", "mens", "women", "dna"]  # วนซ้ำ
...
SERVICE_CONTEXT = {
    ...
    "dna": {
        ...
        "topics": (
            "ตรวจ DNA พ่อลูก, ตรวจ DNA ราคา, พิสูจน์ความเป็นบิดา, "
            "จดทะเบียนรับรองบุตร, เพิ่มชื่อพ่อในสูติบัตร, สิทธิของบุตรนอกสมรส, "
            "ค่าอุปการะเลี้ยงดูบุตร, คดีมรดกกับการพิสูจน์ทายาท, "
            "ตรวจ DNA ขอสัญชาติ, วีซ่าติดตามครอบครัว, "
            "chain of custody, ห้องปฏิบัติการ ISO/IEC 17025, "
            "ความยินยอมกับ PDPA, ตรวจ DNA พี่น้อง, ตรวจ DNA ปู่ย่าตายาย"
        ),
        "compliance": (
            "COMPLIANCE สำหรับ DNA (บังคับ — ห้ามผ่อนปรน): "
            "ห้ามเขียนหรือสื่อว่า 'ตรวจ DNA ฟรี' เด็ดขาด — voucher คือปรึกษาฟรี ค่าตรวจแยกต่างหาก; "
            "ห้ามแนะนำหรือทำให้ดูเป็นไปได้ว่าจะเก็บตัวอย่างของอีกฝ่ายมาตรวจโดยเขาไม่รู้ตัว "
            "ต้องระบุเสมอว่าต้องได้รับความยินยอมจากทุกฝ่าย (ผู้เยาว์ = ผู้ปกครองตามกฎหมาย); "
            "ห้ามการันตีผลทางกฎหมาย เช่น 'ตรวจแล้วชนะคดีแน่นอน'; "
            "ตัวเลขความแม่นยำและระยะเวลารอผลต้องอ้างว่าเป็นของห้องปฏิบัติการ ไม่ใช่คำเคลมของเรา; "
            "ราคาให้เขียนเป็นช่วงราคาตลาดเท่านั้น ห้ามอ้างเป็นราคาของเรา (พาร์ทเนอร์แล็บยังไม่ยืนยัน); "
            "หากกล่าวถึงการตรวจก่อนคลอด (NIPP) ต้องระบุว่าเป็นหัตถการทางการแพทย์ ต้องให้แพทย์ประเมินก่อน; "
            "ต้องมีข้อความว่ารู้ก่อนดี(รู้งี้)เป็นผู้ให้ข้อมูลและประสานงานนัดหมาย ไม่ใช่ผู้ให้บริการตรวจ; "
            "ต้องมีข้อความว่าบทความนี้ไม่ใช่คำแนะนำทางกฎหมาย; "
            "tone เป็นความลับ ไม่ตัดสิน ไม่ใช้โทนจับผิด/จับชู้"
        ),
    },
}
