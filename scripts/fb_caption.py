...
SERVICE_HASHTAGS = {
    ...
    "foreign": "#แรงงานต่างด้าว #ตรวจสุขภาพ #ใบรับรองแพทย์ #workpermit #MOU",
...
def generate_caption(post: dict, link: str) -> str:
    ...
    system_prompt = (
        ...
        "- จบด้วย hashtag ที่เกี่ยวข้อง 3-5 อัน (ใช้ตามรายการ Hashtag แนะนำเป็นหลัก ห้ามสะกดผิด เช่น workpermit ห้ามเขียน wodpermit)\n"
    ...
    if is_mens:
        system_prompt += (
            ...
            "- เพิ่มประโยค 'ปรึกษาแพทย์ที่ โรงพยาบาลพันธมิตร'"
        )
