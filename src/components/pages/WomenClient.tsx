...
const jsonLd = {
  ...
  description: 'ปรึกษาสูตินรีแพทย์ฟรี + ตรวจประเมินสุขภาพเพศหญิงเบื้องต้น — HPV, Pap smear, ตกขาว, ประจำเดือน, วัยทอง ภายใต้การดูแลของแพทย์ โรงพยาบาลพันธมิตรในสมุทรสาคร',
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'ทำไมต้องไปโรงพยาบาลพันธมิตร?', acceptedAnswer: { '@type': 'Answer', text: 'โรงพยาบาลคู่ค้าของเรามีสูตินรีแพทย์และ lab มาตรฐาน สามารถดูแลตั้งแต่การตรวจ วินิจฉัย และติดตามผล ครบทุกขั้นตอนภายใต้การกำกับของแพทย์ผู้รับผิดชอบ' } },
  ],
}
...
export default function WomenClient() {
  ...
  const FAQS = [
    { q: t.women.faq1q, a: t.women.faq1a },
    { q: t.women.faq2q, a: t.women.faq2a },
    { q: t.women.faq3q, a: t.women.faq3a },
    { q: t.women.faq4q, a: t.women.faq4a },
    { q: t.women.faq5q, a: t.women.faq5a },
    { q: t.women.faq6q, a: t.women.faq6a },
  ]
