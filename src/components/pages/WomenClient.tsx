...
const FAQS = [
  ...
  { q: 'ทำไมต้องไปโรงพยาบาลพันธมิตร?', a: 'โรงพยาบาลคู่ค้าของเรามีสูตินรีแพทย์และ lab มาตรฐาน สามารถดูแลตั้งแต่การตรวจ วินิจฉัย และติดตามผล ครบทุกขั้นตอนภายใต้การกำกับของแพทย์ผู้รับผิดชอบ' },
]
