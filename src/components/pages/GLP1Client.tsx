...
export default function GLP1Client() {
  ...
  const FAQS = [
    { q: t.glp1.faq1q, a: t.glp1.faq1a },
    { q: t.glp1.faq2q, a: t.glp1.faq2a },
    { q: t.glp1.faq3q, a: t.glp1.faq3a },
    { q: t.glp1.faq4q, a: t.glp1.faq4a },
    { q: t.glp1.faq5q, a: t.glp1.faq5a },
  ]
    ...
    <main className="min-h-screen bg-cream">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 md:px-10 py-4 flex justify-between items-center bg-cream/90 backdrop-blur-md border-b border-mint/15">
        ...
        <div className="flex items-center gap-3">
          <LanguageSwitcher />
          <Link href="/quiz/glp1" className="bg-forest text-white px-5 py-2 rounded-full text-xs font-semibold hover:bg-sage transition-all">
      ...
      <section className="min-h-[70vh] flex items-center pt-16 px-6 md:px-20 bg-gradient-to-br from-emerald-50 via-cream to-cream">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/quiz/glp1" className="flex items-center justify-center gap-2 bg-forest text-white px-8 py-4 rounded-full text-sm font-semibold hover:bg-sage transition-all shadow-lg">
              {t.glp1.ctaConsult}
            </Link>
      ...
      <section className="py-16 px-6 md:px-20 bg-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/quiz/glp1" className="bg-forest text-white px-8 py-4 rounded-full text-sm font-bold hover:bg-sage transition-all shadow-lg">
              {t.common.consultFree}
            </Link>
