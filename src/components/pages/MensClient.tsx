      ...
      <section className="min-h-[70vh] flex items-center pt-16 px-6 md:px-20 bg-gradient-to-br from-slate-50 via-cream to-cream">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a href="https://line.me/R/ti/p/@roogondee" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 border-2 border-indigo-300 text-indigo-700 px-7 py-4 rounded-full text-sm font-semibold hover:bg-indigo-50 transition-all">
              {t.mens.ctaLine}
            </a>
          </div>
