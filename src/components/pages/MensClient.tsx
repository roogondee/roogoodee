...
const jsonLd = {
  ...
  description: 'ปรึกษาแพทย์เฉพาะทางฟรีเรื่องสุขภาพชายวัย 40+ — ฮอร์โมน พลังงาน อารมณ์ ภายใต้การดูแลของแพทย์ โรงพยาบาลพันธมิตรในสมุทรสาคร',
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'ทำไมต้องไปโรงพยาบาลพันธมิตร?', acceptedAnswer: { '@type': 'Answer', text: 'โรงพยาบาลคู่ค้าของเรามีแพทย์เฉพาะทางและ lab มาตรฐาน สามารถดูแลตั้งแต่การตรวจ วินิจฉัย และติดตามผล ครบทุกขั้นตอนภายใต้การกำกับของแพทย์ผู้รับผิดชอบ' } },
  ],
}
...
const FAQS = [
  ...
  { q: 'ทำไมต้องไปโรงพยาบาลพันธมิตร?', a: 'โรงพยาบาลคู่ค้าของเรามีแพทย์เฉพาะทางและ lab มาตรฐาน สามารถดูแลตั้งแต่การตรวจ วินิจฉัย และติดตามผล ครบทุกขั้นตอนภายใต้การกำกับของแพทย์ผู้รับผิดชอบ' },
]
