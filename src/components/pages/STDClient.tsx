...
const jsonLd = {
  ...
  description: 'บริการตรวจโรคติดต่อทางเพศสัมพันธ์ครบ 10 โรค และ PrEP/PEP ป้องกัน HIV โดย รู้ก่อนดี(รู้งี้) ร่วมกับ โรงพยาบาลพันธมิตรในสมุทรสาคร',
...
export default function STDClient() {
  ...
  const FAQS = [
    { q: t.std.faq1q, a: t.std.faq1a },
    { q: t.std.faq2q, a: t.std.faq2a },
    { q: t.std.faq3q, a: t.std.faq3a },
    { q: t.std.faq4q, a: t.std.faq4a },
    { q: t.std.faq5q, a: t.std.faq5a },
  ]
