...
export default function LINEFloat() {
  ...
  useEffect(() => {
    // Surface the button quickly so the LINE CTA is clearly visible on
    // first view; a short delay keeps a smooth slide-in entrance.
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center gap-2 px-5 py-3.5">
        ...
        <span className="text-sm md:text-base font-bold pr-1 whitespace-nowrap">{t.common.lineConsultFree}</span>
      </span>
    </a>
  )
}
