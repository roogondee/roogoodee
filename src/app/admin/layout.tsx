      ...
      <nav className="bg-forest text-white px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <Link href="/admin/caption-gen" className="text-white/70 hover:text-white transition-colors">📝 Caption</Link>
            <Link href="/admin/fb-health" className="text-white/70 hover:text-white transition-colors">🩺 FB Health</Link>
