...
export const metadata: Metadata = {
  ...
  description: 'HPV / Pap smear / ตกขาว / ประจำเดือน / วัยทอง — ปรึกษาสูตินรีแพทย์ฟรี ภายใต้การดูแลของแพทย์ โรงพยาบาลพันธมิตรในสมุทรสาคร เป็นความลับ ไม่ตัดสิน',
  ...
  openGraph: {
    ...
    description: 'HPV, Pap smear, ตกขาว, ประจำเดือน, วัยทอง — ดูแลโดย โรงพยาบาลพันธมิตร',
