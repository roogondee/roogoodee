...
export default async function BlogPage() {
  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="pt-32 pb-24 px-20">
        <p className="text-xs font-bold tracking-widest uppercase text-mint mb-4">บทความ</p>
        <h1 className="font-display text-5xl text-forest mb-4">ความรู้สุขภาพ</h1>
        <p className="text-muted text-lg mb-16">บทความ Evidence-based อ่านง่าย ครอบคลุมทุกเรื่องสุขภาพ</p>
            ...
            {posts.map(post => (
              <Link key={post.id} href={`/blog/${post.slug}`} className="bg-white rounded-2xl overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <h2 className="font-display text-xl text-forest mt-3 mb-2 leading-tight">{post.title}</h2>
