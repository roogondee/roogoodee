...
export const metadata: Metadata = {
  ...
  description: 'ตรวจสุขภาพแรงงานต่างด้าวเพื่อทำ-ต่อ MOU และ Work Permit ที่ รพ. ได้รับอนุญาตจากกระทรวงสาธารณสุข สมุทรสาคร เริ่ม 500 บาท รอผล 1.5-2 ชม. ใบรับรองแพทย์ใช้ได้ 90 วัน โทร 081-902-3540',
