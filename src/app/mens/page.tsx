...
export const metadata: Metadata = {
  ...
  description: 'พลังงาน อารมณ์ ฮอร์โมน — ปรึกษาแพทย์เฉพาะทางฟรี ภายใต้การดูแลของแพทย์ โรงพยาบาลพันธมิตรในสมุทรสาคร ทำแบบประเมิน 1 นาที รับสิทธิ์ปรึกษาแพทย์',
  ...
  openGraph: {
    ...
    description: 'พลังงาน อารมณ์ ฮอร์โมน — ดูแลโดยแพทย์ โรงพยาบาลพันธมิตร',
